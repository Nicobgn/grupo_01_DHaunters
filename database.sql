...
INSERT INTO `universes` (`universe`) VALUES ('Pokemon'),('Dragon Ball'),('Marvel'),('Yu-Gi-Oh'),('One Piece'),('Digimon');
...
('4', '5', 'Kuriboh', 'Una de las cartas más poderosas de Yugi', 'Magnam minima aperiam ipsum neque nihil eaque nulla mollitia, facilis, incidunt molestias, consectetur perferendis voluptates! Ipsum natus eaque obcaecati nemo. Enim nisi itaque ex voluptatum deleniti, deserunt optio. Harum, tempore!', '18', '5/kuriboh.png', '2022/05/10 15:57:30','2022/05/10 15:57:30'),
('1', '3', 'Haunter', 'Haunter', 'Voluptatum aperiam tenetur necessitatibus eveniet et cum doloremque quam sed quis accusantium! Accusantium illum modi aut inventore repellat! Deserunt tempora ipsum molestias ipsam dignissimos. Quaerat commodi id eum? Voluptatibus, officiis?', '22', '2/ghost-logo-3.png', '2022/05/10 15:57:30','2022/05/10 15:57:30'),
...
('5', '2', 'Ace', 'El hermano de Luffy', 'Adipisci quis, vitae pariatur quam incidunt nesciunt sit iure nisi. Tenetur molestiae repellendus sequi mollitia deserunt quam sunt adipisci omnis eveniet quaerat, facere soluta facilis quas amet ipsam consectetur minus!', '22.99', '2/Ace.png', '2022/05/10 15:57:30','2022/05/10 15:57:30'),
...
('4', '5', 'Dark Magician', 'La carta más poderosa de Yugi', 'Recusandae asperiores porro magni, expedita, consequuntur suscipit temporibus voluptatum architecto ullam assumenda distinctio quo facere perferendis maiores nihil esse? Repellendus necessitatibus quaerat laborum inventore provident illum ullam dolor ea qui.', '94.99', '5/dark-magician.png', '2022/05/10 15:57:30','2022/05/10 15:57:30');
